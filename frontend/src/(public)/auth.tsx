...
import AuthNavbar from "../shared/auth-navbar";

const Auth = () => {
  return (
    <div className="relative bg-[#1c1f27] min-h-screen">
      {/* Atmospheric gradient background - centered radial with #00CECE */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#00CECE]/80 via-[#00CECE]/15 via-20% to-transparent to-100% pointer-events-none" />
